...
MERGED_PATH = os.path.join(BASE_PATH, 'merged_temp')
NEW_TRAIN_PATH = os.path.join(BASE_PATH, 'train_80')
NEW_VALID_PATH = os.path.join(BASE_PATH, 'valid_20')
...
# train + valid klasörlerini birleştir
...
print("Yeni veri bölme tamamlandı: %80 train - %20 valid")
